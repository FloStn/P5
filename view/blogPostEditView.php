...
<section class="content">
   <div class="container-fluid">
      ...
      <div class="row clearfix">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
               ...
               <div class="body">
                  <center>
                  <img src="<?= $post->img() ?>" alt="post_img" class="img-thumbnail" width="50%">
                  <form action="index.php?action=adminBlogPostUpdate&id=<?= $post->idPost() ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="body">
      <textarea id="ckeditor_title" name="title">
      <?= $post->title() ?>
      </textarea>
      </div>
      </div>
      ...
      <div class="body">
      <textarea id="ckeditor_chapo" name="chapo">
      <?= $post->chapo() ?>
      </textarea>
      </div>
      </div>
      ...
      <div class="body">
      <textarea id="ckeditor_content" name="content">
      <?= $post->content() ?>
      </textarea>
      <br>
      <center>
      <input class="btn bg-teal waves-effect" type="submit" value="Mettre à jour l'article">
      </center>
      </div>
      </div>
      </div>
